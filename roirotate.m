...
% 	-------
%        I = imread('ic.tif');
%        J = imrotate(imcrop(I,[60 40 100 90]),-3,'bilinear','crop');
%        [K x y w h] = roirotate(I,[60 40 100 90],-3,'bilinear');
%        imshow(I)
%        rectangle('Position',[60 40 100 90],'EdgeColor','red');
...
padX = abs(ceil(height*sin(pi()*ang/180.0)/2));
padY = abs(ceil(width*sin(pi()*ang/180.0)/2));
